  ...
  return (
    <div className="flex items-center justify-end gap-4 mt-1">
      <div className="flex items-center justify-start gap-1">
        ...
        <button
          onClick={onLike}
          className="flex items-center gap-1 text-text-weak hover:text-red-500 transition-colors"
        >
          {isHearted ? (
      ...
      {/* 북마크 버튼 */}
      <button onClick={onBookmark} className="flex items-center text-text-weak hover:text-[#6952F9] transition-colors">
        {isBookmarked ? (
