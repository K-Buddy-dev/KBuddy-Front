...
const buttonVariants = cva('px-8 rounded-lg font-semibold inline-flex items-center justify-center focus:outline-none', {
  variants: {
    variant: {
...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, color, size, variant, type = 'button', onClick, children, ...props }, ref) => {
    return (
      <button
        ref={ref}
