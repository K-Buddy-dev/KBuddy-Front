...
export function SocialLoginForm() {
  ...
  const VITE_APPLE_AUTH_URL = `https://appleid.apple.com/auth/authorize?client_id=${import.meta.env.VITE_APPLE_CLIENT_ID}&redirect_uri=${import.meta.env.VITE_APPLE_REDIRECT_URI}&response_type=code&scope=name%20email&response_mode=form_post`;
  return (
